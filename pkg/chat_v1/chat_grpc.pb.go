...
func (c *chatServiceClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (UnimplementedChatServiceServer) Delete(context.Context, *DeleteRequest) (*empty.Empty, error) {
